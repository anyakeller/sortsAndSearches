...
//PAPER SHIT FOR SETUP------!!!!
//Initialize paper.js
paper.install(window);
//Jquery elements
var paperDiv = $("#paperVisualDiv");
var paperVisualizationJquery = $("#paperVisualization");
paperVisualizationJquery.width(paperDiv.width());
paperVisualizationJquery.height(250);
//GLOBAL JS HTML ELEMENTS
var paperVisualization = document.getElementById("paperVisualization");
var paperDataBars = []; //data bar elements for paper.js
paper.setup("paperVisualization");
...
function makeDataBar(arr) {
    ...
    var paperBarWidth = paperVisualizationJquery.width() / arr.length;
    var maxHeight = paperVisualizationJquery.height();
    for (var i = 0; i < arr.length; i++) {
        var paperBarHeight = (250 * arr[i]) / maxnum;
        //PAPER TESTING !!!!_!_!_!_!_!_!_
        var startPoint = new Point(i * paperBarWidth, maxHeight);
        var endPoint = new Point();
        var rectangle = new Rectangle(
            startPoint,
            new Point((i + 1) * paperBarWidth, maxHeight - paperBarHeight)
        );
        var path = new Path.Rectangle(rectangle);
        path.fillColor = "black";
        paperDataBars.push(path);
    }
}
